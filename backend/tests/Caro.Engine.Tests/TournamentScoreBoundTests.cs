...
public class TournamentScoreBoundTests
{
    ...
    // Replays a 16x16 round-robin archive. TournamentReplay regenerates the
    // seeded opening from Board.Size, so on the 15x15 board this recorded
    // move list no longer describes the same game (it also contains
    // coordinates such as 15,11 that do not exist on a 15x15 board).
